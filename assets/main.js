...
document.querySelector('.open_more_com').addEventListener('click', function (e) {
  e.preventDefault();
  
  const hiddenItems = document.querySelectorAll('.reviews-item.hidden');
  ...
  if (document.querySelectorAll('.reviews-item.hidden').length === 0) {
